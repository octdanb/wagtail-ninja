...
# TODO: The recursion is happening here
    ...
    interfaces = tuple(
        {
            ...
            *getattr(cls, "wagtail_ninja_interfaces", ()),
        }
    )
...
def register_wagtail_ninja_schema(schema_cls):
...
def register_field_middleware(field_name: str, middleware_list: list):
    ...
    if wagtail_ninja_settings.AUTO_CAMELCASE:
...
def register_query_field(
    ...
    *,
    ...
    from .schemas.structures import QuerySetList
    ...
    def inner(cls):
        ...
        if field_query_params is None:
            field_query_params = {"id": int}

            if issubclass(cls, Page):
                field_query_params["slug"] = str
                field_query_params["url_path"] = str
                field_query_params["token"] = str
        ...
        def Mixin():
            ...
            setattr(
                schema,
                field_name,
                singular_field_type(**field_query_params),
            )
...
def register_paginated_query_field(
    ...
    *,
    ...
    from .schemas.structures import PaginatedQuerySet
